...
flags.DEFINE_string("dataset", "coco_64", "The name of dataset [celebA, mnist, lsun]")
...
flags.DEFINE_integer("Lambda", 20, "Gradient penalty lambda hyperparameter")
flags.DEFINE_integer("Alpha",1,"Weight for fake-label loss")
flags.DEFINE_integer("d_pre_train_step",300,"Number of steps for pre-training the discriminator")
