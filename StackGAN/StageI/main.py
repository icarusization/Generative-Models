...
flags.DEFINE_float("learning_rate_d", 0.0002, "Learning rate of for rmsprop [0.0002]")
flags.DEFINE_float("learning_rate_g", 0.0002, "Learning rate of for rmsprop [0.0002]")
